...
class ChallengingStoryStructureSearcher:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        differentiating_actions, all_allowed_actions, world_building_actions = (
    ...
    def _is_story_final_wrt_actions_and_people(
        ...
        num_differentiating_actions_performed, num_moves_performed = (
    ...
    def _compute_average_lookahead_story_length(
        ...
        if is_already_final_story_wrt_actions_and_people:
            ...
            for _ in range(self.BASE_LOOKAHEAD):
                belief_tracker_copy, function_list_copy, action_type_counter_copy = (
                    copy.deepcopy(
                        [belief_tracker1, function_list1, action_type_counter1]
                    )
                )
                _, belief_tracker_output, action_type_counter_output, _ = (
    ...
    def complete_story_randomly_and_incrementally(
        ...
        belief_tracker_orig, function_list_orig, action_type_counter_orig = (
            copy.deepcopy([belief_tracker, function_list, action_type_counter])
        )
        ...
        while (
            ...
            belief_tracker, function_list, action_type_counter, function_identifier = (
                self._execute_next_sampled_action(
                    belief_tracker,
                    function_list,
                    action_type_counter,
    ...
    def main(self, max_sentences, max_nodes_allowed_to_explore):
        ...
        while (
            ...
            if (
                ...
                break
            if (
                "openai" in self.model_call_handler.model_access_method
                and self.model_call_handler.accum_token_cost() > 1e6 / 15 * 0.1
            ):
                break
            ...
            for (
                ...
                if node in self.solved_story_cache:
                    ...
                    lookahead_stories, avg_story_len = (
...
class FullStoryStructureSearcher:
    ...
    def main(
        ...
        model_generated_context_dict_list, str_filename_params = (
